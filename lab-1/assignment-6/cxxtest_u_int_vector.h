...
class MyTestSuite : public CxxTest::TestSuite {
	public:
		...
		void test2 () { //Testing the initializer_list-constructor.
			UIntVector a = {1,2,3};
		...
		void test3 () { //Testing the copy constructor.
			UIntVector a((size_t)10);
			UIntVector b = a;
			UIntVector c(b);
		...
		void test4 () { //Testing the move constructor.
			UIntVector a((size_t)10);
			a[0] = (unsigned int)82;
			a[5] = (unsigned int)99;
		...
		void test5 () { //Testing the copy-assignment operator.
			UIntVector a((size_t)10);
			a[0] = (unsigned int)82;
			a[5] = (unsigned int)99;
			a[9] = (unsigned int)10005;
		...
		void test6 () { //Testing the move-assignment operator.
			UIntVector a((size_t)10);
			a[0] = (unsigned int)82;
			a[5] = (unsigned int)99;
			a[9] = (unsigned int)10005;
		...
		void test7 () { //Testing the operator[] overload on const objects.
		...
		void test8 () { //Testing the operator[] overload
			UIntVector a((size_t)10);
			a[0] = (unsigned int)82;
			a[5] = (unsigned int)99;
			a[9] = (unsigned int)10005;
		...
		void test9 () { //Testing the reset member function.
			UIntVector a((size_t)10);
			a[0] = (unsigned int)82;
			a[5] = (unsigned int)99;
			a[9] = (unsigned int)10005;
		...
		void test10 () { //Testing the size member function.
		...
		void test11 () { //Just random testing.
			UIntVector a((size_t)10);
			a[0]++;
			TS_ASSERT_EQUALS(a[0],1);

			UIntVector const b((size_t)10);
			//b[0]++; //When not commented out this should give a compile error since b is const.
			//b = b; //When not commented out this should give a compile error since b is const.
			TS_ASSERT_EQUALS(b.size(),10);
			TS_ASSERT_EQUALS(b[0], 0);
		}
